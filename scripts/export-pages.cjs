...
for (const name of ['assets', 'data', 'notebooks', 'style.css', 'book.css', 'app.js',
  'app.js.LEGAL.txt', 'site.js', 'search-index.js', 'THIRD_PARTY_NOTICES.md']) copy(name);
...
const origin = 'https://example.invalid/statistical-arbitrage/';
